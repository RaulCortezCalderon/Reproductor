...
#frame -  marco
frame_principal = Frame(raiz,bg="#BBA9BB",width=600,height=400)
frame_principal.pack(fill="both", expand=1)
''''
imagenChida = Image.open("bart.jpg")
imagenRepro = imagenChida.rezice((200,150))
img = ImageTk.photoImage(imagenChida)
...
'''
#Titulo Reproductor
tituloreproductor = Label(frame_principal, text = "REPRODUCTOR MUSIC",bg="#4d4d4d",fg="#f4f4f4",font =("COCOGOOSE", 15))
...
#Botonplay
botonplay = Button(frame_principal, text="PLAY",bg="#76EE00", font=("COCOGOOSE", 10),width=10,height=2,bd=0,highlightthickness=0,
                   command= playSONG)
